...
public class MembershipLevelServiceImpl implements MembershipLevelService {
    ...
    public java.math.BigDecimal getCurrentUserDiscount() {
        return discountForUser(com.petshop.security.UserContext.getUserId());
    }

    @Override
    public String getCurrentUserLevelName() {
        return levelNameForUser(com.petshop.security.UserContext.getUserId());
    }

    @Override
    public java.math.BigDecimal discountForUser(Long userId) {
        if (userId == null) {
    ...
    @Override
    public String levelNameForUser(Long userId) {
