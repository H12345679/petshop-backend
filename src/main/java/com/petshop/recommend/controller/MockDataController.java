...
public class MockDataController {
    ...
    public Result<String> mockCfData() {
        ...
        List<Long> catItems = Arrays.asList(1008L, 1009L, 1010L, 1012L, 1014L, 1018L, 1022L, 1027L, 1031L, 1032L, 1033L);
        ...
        // 2. 清理旧 Mock 数据
        jdbcTemplate.update("DELETE FROM user_behavior WHERE user_id >= 1000");
